    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_articlesofwalking);
                ...
                benefitsofwalking.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(Articlesofwalking.this, com.ak.calculatorbmi.benefitsofwalking.class));
                    }
                });
                ...
                walk30minutes.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(Articlesofwalking.this, com.ak.calculatorbmi.walk30minutes.class));
                    }
                });
